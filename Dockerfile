...
# Install build-time dependencies needed for native modules (e.g., canvas, bcrypt)
# g++, make, python3 are for node-gyp. The others are for canvas.
RUN apk add --no-cache g++ make python3 libc-dev cairo-dev jpeg-dev pango-dev giflib-dev
